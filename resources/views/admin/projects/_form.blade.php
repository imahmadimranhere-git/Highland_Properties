        ...
        <x-panel.box title="Media">
            <div class="row">
                ...
                <div class="col-md-4 form-group">
                    ...
                    <div class="banner-preview {{ $project->exists && $project->locationImage ? '' : 'is-empty' }}">
                        @if ($project->exists && $project->locationImage)
                            <img src="{{ $project->locationImage->thumb_url }}" alt="" loading="lazy" width="320" height="180">
                        @else
                            <span class="img-ph">Not uploaded</span>
                        @endif
                    </div>
