...
class SitemapController extends Controller
{
    public function __invoke(): Response
    {
        $xml = Cache::remember(PublicCache::SITEMAP, PublicCache::TTL, function () {
            $static = collect(['home', 'about', 'projects.index', 'developers.index', 'team', 'blog.index', 'testimonials', 'faq', 'contact'])
            ...
            return view('web.sitemap', ['urls' => $static->concat($projects)->concat($developers)->concat($posts)])->render();
        });
